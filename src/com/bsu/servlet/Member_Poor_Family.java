...
/**
 * Servlet implementation class Member_Poor_Family
 */
@WebServlet("/member_poor_family")
public class Member_Poor_Family extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Member_Poor_Family() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sb.append("select * from poor_member_family where 1=1 and parentid=?");
